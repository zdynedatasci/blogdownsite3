---
title: An Exploration of Hospice Care Expenses in the US
author: Zachary Dyne
date: '2019-12-14'
slug: an-exploration-of-hospice-care-expenses-in-the-us
categories:
  - R
  - Healthcare
  - Medicare
...
tags:
  - Healthcare
summary: 'This project analyzes hospice care expenses throughout the United States and showcases a variety of R packages, data wrangling approaches, and statistical techniques. This was my final project for the *GSMDS5001: Fundamentals of Data Science with R* course.'
authors: []
external_link: ''
image:
  caption: ''
...
states <- read_csv("C:/Users/Lenovo/Desktop/AGSM/Fall2019/RCertificate/Medicare Data/states.csv") %>%
...
```
The mean Standard Payment Amount is `r mean(D$"Total Medicare Standard Payment Amount")`, which is notably higher than the median of `r median(D$"Total Medicare Standard Payment Amount")`. This fact, along with a large standard deviation of `r sd(D$"Total Medicare Standard Payment Amount")` points towards either a high skew or the presence of some extreme outliers. 
