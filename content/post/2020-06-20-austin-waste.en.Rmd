...
tags: []
subtitle: ''
summary: 'Have you ever wondered how much waste is produced in a large US city? This post uses Tableau and R to explore the Austin, Texas Waste Collection & Diversion Daily Report to answer that question from several angles and compares the impact of population growth on garbage and recycling usage.'
authors: []
...
The above dashboard aims to provide an overview of volume and weight of Austin, Texas's Waste Collection & Diversion Daily report. I was curious to see whether any variation in pickup weight and/or volume could be explained by population changes in the region. To simplify things for now, let's only focus on the Garbage Collection and Recycling - Single Stream route types, which have the highest volume and weight of any other type of pickup.
